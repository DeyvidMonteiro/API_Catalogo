...
public class AuthController : ControllerBase
{
        ...
        if (!roleExist)
        {
            ...
            else
            {
                ...
                return StatusCode(StatusCodes.Status400BadRequest,
                    ...
                    {
                        Status = "Error",
                        Message = $"Issue adding the new {roleName} roel"
                    });
            }
        }
        return StatusCode(StatusCodes.Status400BadRequest,
    ...
    public async Task<IActionResult> AddUserToRole(string email, string roleName)
    {
        ...
        if (user != null)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation(1, $"User {user.Email} Added to the {roleName} Roles");
                return StatusCode(StatusCodes.Status200OK,
                    new Response
                    {
                        Status = "Success",
            ...
            else
            {
                ...
                return StatusCode(StatusCodes.Status400BadRequest,
                    ...
                    {
                        Status = "Error",
                        Message = $"Error: Unable to add user {user.Email} to role {roleName}"
                    });
            }
        }
